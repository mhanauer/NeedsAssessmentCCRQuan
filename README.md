...
rbbcsc = rbbcsc[-c(1:2),]
head(rbbcsc)
rbbcsc1 = rbbcsc[c("Q4_1", "Q4_2", "Q4_3", "Q4_4", "Q4_5", "Q4_6")]
eth = rbbcsc[c("Q11")]
gender = rbbcsc[c("Q10")]
edu = rbbcsc[c("Q12")]
job = rbbcsc[c("Q15")]
...
head(rbbcsc, 20)
head(rbbcsc)
colnames(rbbcsc) = c("CCRQuant1", "CCRQuant2", "CCRQuant3", "CCRQuant4", "CCRQuant5", "CCRQuant6", "eth", "gender", "edu", "job") 
head(rbbcsc)
...
head(mccsc)
colnames(mccsc) = c("CCRQuant1", "CCRQuant2", "CCRQuant3", "CCRQuant4", "CCRQuant5", "CCRQuant6", "eth", "gender", "edu", "job") 
head(mccsc)
...
dim(mccsc)
dim(rbbcsc)
bothGender = bothAll[c("CCRQuant1", "CCRQuant2", "CCRQuant3", "CCRQuant4", "CCRQuant5", "CCRQuant6", "gender")]
head(bothGender)
...
bothGender = bothAll[c("CCRQuant1", "CCRQuant2", "CCRQuant3", "CCRQuant4", "CCRQuant5", "CCRQuant6", "eth")]
head(bothGender)
bothGender = na.omit(bothGender)
bothGender = apply(bothGender,2, function(x){ifelse(x == "NA", NA, x)})
bothGender = na.omit(bothGender)
...
bothGender = apply(bothGender,2, function(x){ifelse(x == "NA", NA, x)})
# Change this
bothGender = bothAll[c("CCRQuant1", "CCRQuant2", "CCRQuant3", "CCRQuant4", "CCRQuant5", "CCRQuant6", "edu")]
head(bothGender)
bothGender = na.omit(bothGender)
bothGender = apply(bothGender,2, function(x){ifelse(x == "NA", NA, x)})
bothGender = na.omit(bothGender)
...
bothGender = apply(bothGender,2, function(x){ifelse(x == "NA", NA, x)})
# Change this
bothGender = bothAll[c("CCRQuant1", "CCRQuant2", "CCRQuant3", "CCRQuant4", "CCRQuant5", "CCRQuant6", "job")]
head(bothGender)
bothGender = na.omit(bothGender)
bothGender = apply(bothGender,2, function(x){ifelse(x == "NA", NA, x)})
bothGender = na.omit(bothGender)
